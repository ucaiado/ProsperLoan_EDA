...
Now, I am going to see break up the Debt To Income Ratio into a categorical one.
The most of classes I have defined as the quartiles.
...
Here is something useful. There is some relationship between the two variables 
and it is coherent. The more one is in debt, the more expensive is to take more 
loans.
...
the bigger income, the smaller the interest rates.
...
Here I also found some relationship. I guess It can't be different . When you 
...
It is the way that works between countries, makes sense that works like that 
between people. If someone earns more money per month or he has a house, you 
might be more confident that will receive your money back.


Well...I am talking over risk and uncertanty....but, first of all, risky laon 
realy ate riskyer? Let's check default ratio?
