...
There are 6 variables in the data set that seems to be created to comply those rules (they are just valid to loans originated after 2009). 

Let's beginning understand what are the variable in my hand. Besides these 6 variavles mentioned, I can see that there are at least 5 variables related to dates and 6 that are just valid to loans originated after 2009. 
