...
####Loan Meta Data: Loan Original Amount and how it is distributed
...
####Loan Return: Close Look at the Distribution of Borrower Rates
...
####Wrapping Up the univariate analyses
...
#box plot of income range filtered by risk
...
```
The percentage of default loans increases from February (6%) to March (9%) with 
a peak in April (12%). The average borrower rate also increases during these 
months from 15% to 17% to 20%. -----REESCREVER
...
loans by the year when the loans were closed, splitting them by term.
...
of the loans with term of 60 month sharply increased, what can be checked in the
chart before this, the median of borrowers rate also increased.
