...
It doesn't add up much to my thoughts. I believe that this variables have to be 
...
As the prosper rating is discrete and borrower Rate is continuous, the chart is 
bit confuse, but I can see that, in fact, there is some relathionship between the
two variable. I am going to add some jitter and change the alpha to reduce the
...
This chart shows that loans with higher ineterest rate are much common in laons 
with higher risk. What about risk score and income range. I am also filtering 
monthly income equal to 0 (zero). 
...
Intresting. There is no evidence of relationship at all. I mean, there is a 
concentration around $5,000 dolar of income by month and between 3 to 6 risk 
scores, but I believe that it is more related to the typical american profile 
than a relationship between income and risk score. I am also seing that even 
 people with high income are classified as high risk. Maybe ...
