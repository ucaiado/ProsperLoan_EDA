...
There are 6 variables in the data set that seems to be created to comply those rules. They are just valid to loans originated after 2009 and, in general, they are all about how much interest have been payed and how risky each loan were. Looking at other variables, I can see that they are pretty diverse but they are all related to those two factors: risk and return.
...
How P2PL is something new for me, I would like to understand how it works on United States and I will use this data base to acchive that.
...
Something is puzzleling me. What I understand until now is that Peer-to-peerlending is someone lending money directly to somebody else, without a financial institution between them. Given that one of the golden rules when you want to reduce the risk of an investment  is <aa href="http://en.wikipedia.org/wiki/Diversification_%28finance%29">diversification</a>, a peer-to-peer lender should split their money to different borrowers as much a possible. 
